...
statement 	: 	expression_statement {
			...
			|	FOR LPAREN expression_statement expression_statement expression RPAREN statement {
					...
					/*
						...
						add $4's code then compare $4's symbol with 1
			...
			|	PRINTLN LPAREN ID RPAREN SEMICOLON {
					...
					// decimal print procedure outdec procedure
					// send argument through ax
					$$=new SymbolInfo();
					$$->code += $3->code;
					$$->code += "mov ax, "+$3->Name+"\n";
					$$->code += "call PRINTLN\n";
...
logic_expression : rel_expression {
		...
		| rel_expression LOGICOP rel_expression {
					...
					if(strcmp($2->getSymbol(),"&&")==0){
						/* 
						Check whether both operands value is not 0. If both are not 0 set value of a temporary variable to 1
						otherwise 0
						*/
					}
